...
impl FractalEngine {
    pub fn new() -> Self {
        FractalEngine {rng: Pcg64::seed_from_u64(0), width: 3072, height: 3072, messiness: 30,
        coloring: ColorConfig::new(), sample_path: String::from(""), image_fractal_hue: 0.0}
    }
        ...
        for x in 0..(width as f32 /2.0).ceil() as u32 {
            for y in 0..height {
                ...
                for i in 0..1000 {
                    ...
                    z = z*z+c;
                    let mut p = z + Complex::new(1.0, 1.0);
